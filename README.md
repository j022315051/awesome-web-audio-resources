...
- [Tonalux Audio Analyzer](https://tonalux.org/analyzer.html) - open source (MIT) in-browser audio analyzer (LUFS, True Peak, BPM, key, spectrum, stereo). [Source](https://github.com/Exenye/tonalux-analyzer).
